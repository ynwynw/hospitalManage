...
let  objtemp= {
detailList,
 yaopinleixing: data.yaopinleixing,
}
...
const obj={
yaopinleixing: this.data. yaopinleixing,
}
...
let corssRes = await list(`yaopinleixing`, params)
crossoptnum = wx.getStorageSync('statusColumnName');
...
//跨表计算
if (ruleForm.id ) {
await update(`yaopinleixing`, ruleForm)
}
else {
 this.data?.commentScore?ruleForm['score']= this.data.commentScore:'';
 await add(`yaopinleixing`, ruleForm)
}
}
}
else {
