...
.main-container{
    ...
    padding: 121px 0px 0px !important;
    background: #F4F4F4;
    overflow: hidden;
}
...
.menu_wrapper .menu_view .el-menu-item:hover{color: var(--theme);}
...
.menu_wrapper .el-menu-item.first-item {background: #fff;}

.menu_wrapper li.first-item.el-sub-menu.is-opened {
    background: #fff;
}
...
.menu_wrapper .first-item:nth-child(5n+1) i:first-child {
    color: #D3623D;
}
.menu_wrapper .first-item:nth-child(5n+2) i:first-child {
    color: #36B874;
}
.menu_wrapper .first-item:nth-child(5n+3) i:first-child {
    color: #2EA6E7;
}
.menu_wrapper .first-item:nth-child(5n+4) i:first-child {
    color: #3965E1;
}
.menu_wrapper .first-item:nth-child(5n+5) i:first-child {
    color: #DFB528;
}
</style>